package delta.games.lotro.gui.pets.explorer;
...
import delta.games.lotro.gui.pets.PetsTableController;
import delta.games.lotro.lore.collections.pets.CosmeticPetDescription;

/**
 * Controller the pets explorer panel.
 * @author DAM
 */
public class PetsExplorerPanelController implements FilterUpdateListener
{
  // Data
   ...
   */
  public PetsExplorerPanelController(WindowController parent, PetsTableController tableController)
  {
    _parent=parent;
  ...
  private JPanel build()
  {
    ...
    ActionListener al=new ActionListener()
    {
      ...
      {
        TableColumnsChooserController<CosmeticPetDescription> chooser=new TableColumnsChooserController<CosmeticPetDescription>(_parent,_tableController.getTableController());
        chooser.editModal();
      }
    };
