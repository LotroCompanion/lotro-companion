...
public class ImbuedLegacyInstanceEditionPanelController
{
  ...
  private JPanel build()
  {
    ...
    for(int i=0;i<nbEditors;i++)
    {
      ...
      GridBagConstraints c=new GridBagConstraints(x,i,1,1,1.0,0.0,GridBagConstraints.WEST,GridBagConstraints.HORIZONTAL,new Insets(5,5,5,5),0,0);
      panel.add(valueLabel,c);
      x++;
      // Current level
      ComboBoxController<Integer> currentLevelCombo=editor.getCurrentLevelCombo();
      c=new GridBagConstraints(x,i,1,1,0.0,0.0,GridBagConstraints.WEST,GridBagConstraints.NONE,new Insets(5,5,5,0),0,0);
      panel.add(currentLevelCombo.getComboBox(),c);
      x++;
      // Max level
      ComboBoxController<Integer> maxLevelCombo=editor.getMaxLevelCombo();
      c=new GridBagConstraints(x,i,1,1,0.0,0.0,GridBagConstraints.WEST,GridBagConstraints.NONE,new Insets(5,5,5,5),0,0);
