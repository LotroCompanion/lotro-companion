...
/**
 * Renderer for a skill status cell.
 * @author DAM
 */
public class SkillStatusCellRenderer implements TableCellRenderer
{
   ...
   * Constructor.
   */
  public SkillStatusCellRenderer()
  {
  ...
  {
    SkillStatus status=(SkillStatus)value;
