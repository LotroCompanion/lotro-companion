...
public class TaskDeedsStatusPanelController
{
  ...
  private JPanel build()
  {
    ...
    JPanel achievedPanel=buildLabeledBar("Achieved deed:",_achievedDeed,_global);
    ...
    _deedInProgressPanel=buildLabeledBar("Next deed:",_deedInProgressLabel,_deedInProgressProgress);
