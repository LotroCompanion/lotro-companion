 ...
 * @author DAM
 */
public class RelicsInventoryPanelController implements FilterUpdateListener
{
  // Data
   ...
   */
  public RelicsInventoryPanelController(WindowController parent, RelicsInventoryTableController tableController)
  {
    _parent=parent;
  ...
  private JPanel build()
  {
    ...
    ActionListener al=new ActionListener()
    {
      ...
      {
        TableColumnsChooserController<RelicsInventoryEntry> chooser=new TableColumnsChooserController<RelicsInventoryEntry>(_parent,_tableController.getTableController());
        chooser.editModal();
      }
    };
