...
public class VirtuesDisplayPanel
{
  ...
  // Controllers
  private VirtuesFromDeedsTableController _tableController;
  ...
  public VirtuesDisplayPanel(WindowController parent, DeedsStatistics stats)
  {
    _parent=parent;
    _stats=stats;
    _tableController=new VirtuesFromDeedsTableController(stats);
  }
  ...
  private JPanel build()
  {
    ...
    ActionListener al=new ActionListener()
    {
      ...
      {
        TableColumnsChooserController<VirtueStatsFromDeeds> chooser=new TableColumnsChooserController<VirtueStatsFromDeeds>(_parent,_tableController.getTableController());
        chooser.editModal();
      }
    };
