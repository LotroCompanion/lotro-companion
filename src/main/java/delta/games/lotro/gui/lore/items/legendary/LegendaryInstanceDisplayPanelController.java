...
import delta.games.lotro.gui.lore.items.legendary.imbued.ImbuedLegendaryAttrsDisplayPanelController;
import delta.games.lotro.gui.lore.items.legendary.non_imbued.NonImbuedLegendaryAttrsDisplayPanelController;
import delta.games.lotro.gui.lore.items.legendary.relics.RelicsSetDisplayController;
import delta.games.lotro.gui.lore.items.legendary.titles.LegendaryTitleDisplayPanelController;
