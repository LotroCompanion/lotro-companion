...
/**
 * Controller the emotes explorer panel.
 * @author DAM
 */
public class EmotesExplorerPanelController implements FilterUpdateListener
{
  // Data
   ...
   */
  public EmotesExplorerPanelController(WindowController parent, EmotesTableController tableController)
  {
    _parent=parent;
  ...
  private JPanel build()
  {
    ...
    ActionListener al=new ActionListener()
    {
      ...
      {
        TableColumnsChooserController<EmoteDescription> chooser=new TableColumnsChooserController<EmoteDescription>(_parent,_tableController.getTableController());
        chooser.editModal();
      }
    };
  ...
  private void updateStatsLabel()
  {
    ...
    {
      label="Emote(s): "+nbItems;
    }
    else
    {
      label="Emote(s): "+nbFiltered+"/"+nbItems;
    }
