 ...
 * @author DAM
 */
public class SkillFilterController implements ActionListener
{
  // Data
   ...
   */
  public SkillFilterController(SkillFilter filter, FilterUpdateListener filterUpdateListener)
  {
    _filter=filter;
   ...
   */
  public Filter<SkillDescription> getFilter()
  {
    return _filter;
  }
  ...
  private JPanel build()
  {
    ...
    // Skill attributes
    JPanel skillPanel=buildEmotePanel();
    Border border=GuiFactory.buildTitledBorder("Skill");
    skillPanel.setBorder(border);
