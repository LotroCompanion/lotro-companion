...
/**
 * Controller the quests explorer panel.
 * @author DAM
 */
public class QuestsExplorerPanelController implements FilterUpdateListener
{
  // Data
   ...
   */
  public QuestsExplorerPanelController(WindowController parent, QuestsTableController tableController)
  {
    _parent=parent;
  ...
  private JPanel build()
  {
    ...
    TitledBorder itemsFrameBorder=GuiFactory.buildTitledBorder("Items"); // I18n
    ...
    ActionListener al=new ActionListener()
    {
      ...
      {
        TableColumnsChooserController<QuestDescription> chooser=new TableColumnsChooserController<QuestDescription>(_parent,_tableController.getTableController());
        chooser.editModal();
      }
    };
