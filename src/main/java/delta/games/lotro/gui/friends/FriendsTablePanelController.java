 ...
 * @author DAM
 */
public class FriendsTablePanelController implements FilterUpdateListener
{
  // Data
  private FriendsTableController _tableController;
  // GUI
   ...
   */
  public FriendsTablePanelController(WindowController parent, FriendsTableController tableController)
  {
    _parent=parent;
  ...
  private JPanel build()
  {
    ...
    TitledBorder itemsFrameBorder=GuiFactory.buildTitledBorder("Friends");
    ...
    ActionListener al=new ActionListener()
    {
      ...
      {
        TableColumnsChooserController<Friend> chooser=new TableColumnsChooserController<Friend>(_parent,_tableController.getTableController());
        chooser.editModal();
      }
    };
  ...
  private void updateStatsLabel()
  {
    ...
    {
      label="Friend(s): "+nbItems;
    }
    else
    {
      label="Friend(s): "+nbFiltered+"/"+nbItems;
    }
