package delta.games.lotro.items.index.io.xml;
...
import delta.games.lotro.items.index.ItemCategory;
import delta.games.lotro.items.index.ItemSummary;
import delta.games.lotro.items.index.ItemsIndex;
