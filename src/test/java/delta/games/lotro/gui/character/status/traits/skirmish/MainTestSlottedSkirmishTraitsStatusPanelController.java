...
/**
 * Test class for the slotted skirmish traits status panel.
 * @author DAM
 */
public class MainTestSlottedSkirmishTraitsStatusPanelController extends TestCase
{
  /**
  ...
  public static void main(String[] args)
  {
    ...
    JFrame f=c.getFrame();
    SlottedSkirmishTraitsStatusPanelController s=new SlottedSkirmishTraitsStatusPanelController(c,status);
